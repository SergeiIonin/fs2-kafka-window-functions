...
class ProducerServicePlainImpl[F[_] : Async : Concurrent, K, V](kafkaProducer: KafkaProducer[F, K, V]) extends AbstractProducerService[F, K, V](kafkaProducer)

object ProducerServicePlainImpl {
  def make[F[_]: Async, K, V](props: Map[String, String])(implicit serializerK: Serializer[F, K],
